...
interface PildhoraImageLogoProps {
  className?: string;
  showText?: boolean;
  imageSrc?: string;
  altText?: string;
...
export const PildhoraImageLogo: React.FC<PildhoraImageLogoProps> = ({
  className = "w-12 h-12",
  showText = false,
  imageSrc = "/dist/assets/Pildhora.png",
  altText = "Pastillero Pildhora - Dispositivo inteligente para medicación"
}) => {
